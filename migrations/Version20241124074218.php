 ...
 */
final class Version20241124074218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answers (id INT AUTO_INCREMENT NOT NULL, dialog_id INT NOT NULL, content LONGTEXT NOT NULL, reactions VARCHAR(255) DEFAULT NULL, emoji VARCHAR(10) DEFAULT NULL, health VARCHAR(5) DEFAULT NULL, energy VARCHAR(5) DEFAULT NULL, mood VARCHAR(5) DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, hunger VARCHAR(5) DEFAULT NULL, stress VARCHAR(5) DEFAULT NULL, INDEX IDX_50D0C6065E46C4E2 (dialog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dialogs (id INT AUTO_INCREMENT NOT NULL, parent_dialog_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, selected_answer INT DEFAULT NULL, emoji VARCHAR(10) DEFAULT NULL, reactions VARCHAR(255) DEFAULT NULL, health VARCHAR(5) DEFAULT NULL, energy VARCHAR(5) DEFAULT NULL, mood VARCHAR(5) DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, hunger VARCHAR(5) DEFAULT NULL, stress VARCHAR(5) DEFAULT NULL, INDEX IDX_B8F7AEA7AF0DEB0C (parent_dialog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE family_members (id INT AUTO_INCREMENT NOT NULL, main_character_id INT NOT NULL, name VARCHAR(255) NOT NULL, age INT NOT NULL, bio LONGTEXT DEFAULT NULL, hobbies JSON DEFAULT NULL, role_in_family VARCHAR(255) DEFAULT NULL, role_in_it_team VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, health INT DEFAULT 100 NOT NULL, energy INT DEFAULT 100 NOT NULL, mood INT DEFAULT 50 NOT NULL, state VARCHAR(255) DEFAULT \'normal\' NOT NULL, hunger INT DEFAULT 50 NOT NULL, stress INT DEFAULT 50 NOT NULL, INDEX IDX_28B4064388E0BCC (main_character_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE main_characters (id INT AUTO_INCREMENT NOT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, name VARCHAR(255) NOT NULL, age INT NOT NULL, bio LONGTEXT DEFAULT NULL, hobbies JSON DEFAULT NULL, role_in_family VARCHAR(255) DEFAULT NULL, role_in_it_team VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, health INT DEFAULT 100 NOT NULL, energy INT DEFAULT 100 NOT NULL, mood INT DEFAULT 50 NOT NULL, state VARCHAR(255) DEFAULT \'normal\' NOT NULL, hunger INT DEFAULT 50 NOT NULL, stress INT DEFAULT 50 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
